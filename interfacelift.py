...
# -- Changable Variables
url             = 'http://interfacelift.com/wallpaper/downloads/date/widescreen/1920x1200/' #Browse to the page that has all the wallpaper you want and paste here
directory       = '/Volumes/ARCHIVE/interfacelift' #Path to download to
stoponfind      = '0' # Set to 0 to download all files even if the file exists and 1 to stop when it finds where it left off
        ...
        for picture in pictures:
                ...
                if os.path.exists(directory + "/" + picturefile):
                        if stoponfind == "1":
                                ...
                                print 'Already downloaded ' + picturefile + ', skipping ...'
                                continue
